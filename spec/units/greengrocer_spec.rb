RSpec.describe Greengrocer do
  ...
  describe ".initialize" do
    context "インスタンスが生成されたとき" do
      ...
      it "@productsの最初の要素ととproduct_paramsの最初の要素の名前が同じであること" do
        expect(products[0].name).to eq "トマト"
      end

      it "@productsの最初の要素ととproduct_paramsの最初の要素の金額が同じであること" do
  ...
  describe ".register_product" do
    ...
    it "@productsの最後の要素とadding_product_paramsの最後の金額の金額が同じであること" do
      greengrocer.register_product(adding_product_params)
