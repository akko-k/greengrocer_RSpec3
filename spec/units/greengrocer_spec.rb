RSpec.describe Greengrocer do
  ...
  describe ".initialize" do
    context "インスタンスが生成されたとき" do
      it "@productsの要素の数がproduct_paramsの要素の数に等しいこと" do
        expect(products.size).to eq 2
      end

      it "@productsの最初の要素の名前がproduct_paramsの最初の要素の名前に等しいこと" do
        expect(products[0].name).to eq "トマト"
      end

      it "@productsの最初の要素の金額がproduct_paramsの最初の要素の金額に等しいこと" do
  ...
  describe ".register_product" do
    ...
    it "@productsの最後の要素の名前がadding_product_paramsの最後の要素の名前と等しいこと" do
      expect(products[-1].name).to eq "れんこん"
    end

    it "@productsの最後の要素の金額がadding_product_paramsの最後の要素の金額に等しいこと" do
